...
const seed = async () => {
    ...
    `, [hashedPassword]);
        ...
        const cars = [
            ...
            { brand: 'Ford', model: 'Focus', year: 2017, price: 870000, mileage: 120000, color: 'White', vin: 'WF05XXGCC5HK012358' },
            ...
            { brand: 'Lexus', model: 'RX350', year: 2019, price: 4300000, mileage: 52000, color: 'Black', vin: 'JTJBZMCA7K20123602' },
